...
# Data Summary for microsoft_phi-2 
...
**1.2.1 Versioned model name(s):** Phi-2 

 

**1.2.2 Model release date:** 12-Dec-2023 
...
**1.3.1.B Text training data content:** Combination of NLP synthetic data created by Azure OpenAI GPT-3.5 and filtered web data from Falcon RefinedWeb and SlimPajama, which was assessed by Azure OpenAI GPT-4 
...
**1.3.2 Latest date of data acquisition/collection for model training:** 10/01/2023 
...
**1.3.4 Date the training dataset was first used to train the model:** 01-Nov-2023 

 

**1.3.5 Rationale or purpose of data selection:** Datasets focused on textbook-quality content, synthetic texts covering common sense reasoning and general knowledge, and filtered web data for safety and educational value were selected to improve reasoning, language understanding, and coding performance in a compact model 
